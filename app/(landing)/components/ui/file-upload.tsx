        ...
        >
            ...
            {!file ? (
                ...
                <div className="text-center">
                    ...
                    <button 
                        onClick={removeFile}
                        className="flex gap-2 items-center bg-primary/90 text-white mx-auto rounded mt-4 px-3 py-1 hover:bg-primary transition-colors"
                    >
                        <FiTrash2 className="self-center" size={16} /> 
                        <span>Remove</span>
                    </button>
                </div>
            )}
